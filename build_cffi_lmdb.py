...
_config_vars = None
try:
    # Try importing _config module directly without triggering lmdb/__init__.py
    import importlib.util
    spec = importlib.util.spec_from_file_location("_config", "lmdb/_config.py")
...
if _config_vars is None:
    ...
    print("WARNING: lmdb/_config.py not found, using minimal config")
    _config_vars = {
...
# CFFI C code (minimal implementation header)
_CFFI_VERIFY = '''
    #include <stdlib.h>
    #include <stdio.h>
    #include <sys/types.h>
